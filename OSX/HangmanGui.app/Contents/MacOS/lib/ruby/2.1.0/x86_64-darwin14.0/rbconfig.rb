...
module RbConfig
  ...
  CONFIG["EXEEXT"] = ""
  CONFIG["prefix"] = (TOPDIR || DESTDIR + "/Users/ccoupe/.rvm/rubies/ruby-2.1.5")
  ...
  CONFIG["configure_args"] = " '--prefix=/Users/ccoupe/.rvm/rubies/ruby-2.1.5' '--enable-load-relative' '--with-opt-dir=/usr/local/opt/libyaml:/usr/local/opt/readline:/usr/local/opt/libksba:/usr/local/opt/openssl' '--disable-install-doc' '--enable-shared' 'CC=gcc'"
